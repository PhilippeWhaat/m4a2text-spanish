...
transcription_file_name = input("Enter the name for the transcription file (without extension): ").strip() + ".txt"
...
print(f"Transcription completed and corrected. Results saved to '{transcription_file_path}'.")
